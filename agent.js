...
// ─── CONFIG FROM ENV ───
const NODE_ID = process.env.NODE_ID || 'dubai';
const CENTRAL_URL = process.env.CENTRAL_WS_URL || 'wss://latency-central.onrender.com';
const PEERS = JSON.parse(process.env.PEER_IDS || `["mumbai","delhi","singapore","tokyo","sydney","london","frankfurt","virginia","california","brazil","southafrica"]`);
